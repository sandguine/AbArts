...
var ArtExperiment = function() {
  ...
  var theScream = 'static/images/1.jpg';
	...
	var dynamic = 'static/images/training-for-features-task/dynamic-training.png';
	...
	timeline.push(repeatDynaInstructions);
	...
	timeline.push(dynaInstructions);
	...
	for (i = 0; i < testBlocks.length; i++) {
			var testDyna = {
				timeline: [fixation, qDyna],
				timeline_variables: testBlocks[i],
				repetitions: 0,
				randomize_order: true
			};
			timeline.push(testDyna);
