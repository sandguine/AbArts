...
var ArtExperiment = function() {
  ...
  var theScream = 'static/images/1.jpg';
	...
	var valence = 'static/images/training-for-features-task/valence-training.png';
	...
	timeline.push(repeatValeInstructions);
	...
	timeline.push(valeInstructions);

	var i;

	for (i = 0; i < testBlocks.length; i++) {
			var testVale = {
				timeline: [fixation, qVale],
				timeline_variables: testBlocks[i],
				repetitions: 0,
				randomize_order: true
			};
			timeline.push(testVale);
