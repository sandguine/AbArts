function run_BDMpractice1(subID)
%% run_BDM1('150424a')
...
try
    ...
    for i = 1:num_trials
        ...
        % DEC (PRESENTATION)
        shown_item = ['data/imgs_practice/item_',num2str(item_idx(i)),'.jpg'];
        time_DECstrt = GetSecs - time_zero;
        disp_item_practice(wpt, w, h, shown_item, durDEC);
    ...
    fname_log = ['logs/bdm_practice1_sub_',subID];
    ...
    fname_log_time = ['logs/bdm_practice1_sub_',subID,'_time'];
