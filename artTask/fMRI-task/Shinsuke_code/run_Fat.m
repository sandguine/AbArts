...
try
    ...
    str_question = DispString('init', wpt, 'How High Is the Item in Fat?', [0,-h/2.75], floor(h/17), [255, 255, 255], []);
    ...
    fname_log_time = ['logs/fat_sub_',subID,'_time'];
