function run_Carbohydrate(subID)
%%
% run_BDM('150424a')
...
try
    ...
    str_question = DispString('init', wpt, 'How High Is the Item in Carbohydrate?', [0,-h/2.75], floor(h/17), [255, 255, 255], []);
    ...
    fname_log = ['logs/carbohydrate_sub_',subID];
    ...
    fname_log_time = ['logs/carbohydrate_sub_',subID,'_time'];
