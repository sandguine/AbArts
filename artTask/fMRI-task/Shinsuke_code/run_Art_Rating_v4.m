function run_Art_Rating_v4(subID, run_idx,eyetrack)
%% Art rating task kiigaya@gmail.com, mostly based on Shinsuke Suzuki's code
%%  run_Art_Rating_v4('test_short', 1,0)
    ...
    %    heightScalers = linspace(1, 0.2, 10);
     %   imageHeights = screenYpixels .* heightScalers;
      %  imageWidths = imageHeights .* aspectRatio;
        ...
        disp_item(wpt, w*w/s1*3, h, Image_location, durDEC);   %% I need figure this out more carefully
