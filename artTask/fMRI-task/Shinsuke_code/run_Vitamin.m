...
try
    ...
    str_question = DispString('init', wpt, 'How High Is the Item in Vitamin?', [0,-h/2.75], floor(h/17), [255, 255, 255], []);
    ...
    fname_log = ['logs/vitamin_sub_',subID];
    ...
    fname_log_time = ['logs/vitamin_sub_',subID,'_time'];
