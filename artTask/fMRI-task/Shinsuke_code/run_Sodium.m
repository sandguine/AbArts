...
try
    ...
    str_question = DispString('init', wpt, 'How High Is the Item in Sodium (Salt)?', [0,-h/2.75], floor(h/17), [255, 255, 255], []);
    ...
    fname_log = ['logs/sodium_sub_',subID];
    ...
    fname_log_time = ['logs/sodium_sub_',subID,'_time'];
