function [ diff_n_regions,n_label, re_labeled_L] = kernel_graphcut_relabel( image_path, target_n_regions,smoooth_weight, initial_n_label)
...
alpha = smoooth_weight; %The weight of the smoothness constraint
