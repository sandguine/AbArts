function [ diff_n_regions] = kernel_graphcut_relabel_v3( image_path, target_n_regions,x, max_smooth,max_label)
...
alpha = max_smooth/(1+exp(-x(1)))+1; %The weight of the smoothness constraint;
k = round(max_label./(1+exp(-x(2))))+1; %The number of regions
