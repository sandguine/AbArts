function [ diff_n_regions,n_label, L] = kernel_graphcut_rawlabel_parameters( image_path, target_n_regions,smoooth_weight, initial_n_label, max_smooth)
